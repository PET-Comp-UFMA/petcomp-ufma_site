    ...
    <div class="container">
      ...
      <div class="sites-cards">
        <div class="software-card">
          ...
          <div class=" text">
            <h2><a href="http://observatoriodesaudemental.com.br/v2/Observatorio-SaudeMental/">Observatório Saúde Mental</a></h2>
        ...
        <div class="software-card">
          ...
          <div class="text">
            <h2><a href="https://petcompufma.org/cocom/">COCOM</a></h2>
            <div class="wrapper-labels">
              <div class="label php">PHP</div>
              <div class="label html">HTML</div>
              <div class="label css">CSS</div>
        ...
        <div class="software-card">
          ...
          <div class="text">
            <h2><a href="https://petcompufma.org/eacomp/">EAComp</a></h2>
            <div class="wrapper-labels">
              <div class="label html">HTML</div>
              <div class="label css">CSS</div>
              <div class="label javascript">JavaScript</div>
