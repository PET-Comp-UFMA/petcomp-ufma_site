<footer class="fixar-rodape">
    ...
    <div class="div-1">
      ...
      <div class="container">
        <div class="logos">
          <a href="./index.php"><img src="./assets/images/logos/Logo Monocromatica Branca.png" alt="Logo PETComp UFMA" class="pet-logo"></a>
    ...
    <div class="div-2">
      ...
      <div class="lula">
        <div class="infos">
          <ul>
            <li><img src="./assets/svg/map icon.svg" alt=""><p>Av. dos Portugueses, 1966 - Vila Bacanga, São Luís - MA, 65080-805, CCET - Bloco 2 </p></li>
        ...
        <div class="sociais">
          <ul>
            ...
            <li><img src="./assets/svg/twitter icon.svg" alt=""><a href="https://twitter.com/petcompufma"
                target="_blank">@PetCompUfma</a></li>
            <div class="contatos">
