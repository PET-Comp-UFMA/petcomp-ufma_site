...
<body>
  ...
  <div class="noticias">  
    <p>Eventos serão promovidos e organizados pelo grupo. Entre as possíveis opções de eventos estão o EACOMP(Encontro Acadêmico de Computação), PET Game Jam, JIM.
    Os eventos serão planejados através de reuniões entre o grupo. Na primeira reunião, um petiano é eleito líder do monitoramento das atividades a serem realizadas para que ocorra o evento. Este líder, em conjunto com o tutor, indica membros para auxiliá-lo diretamente, podendo inclusive, ser todos os membros do PET. O tutor atua como facilitador entre as várias entidades e atores da universidade. O grupo então define a programação baseada em minicursos, tutorias, palestras, competições, apresentação, rodas de discussão e laboratórios e define também comissões para cuidar de grandes tarefas do evento. A programação é baseada na tendência atual da área e tende a atender os anseios do público diretamente envolvido do curso de Ciência da Computação. Os eventos são então divulgados através de redes sociais em todos os cursos da área do Maranhão, em instituições públicas e particulares, assim como em instituições que possuem cursos técnicos na área. Durante os eventos, as comissões formadas atuam para garantir que a realização do evento ocorra de forma completamente ordenada.</p>
      <div class="materia">
        <img src="./assets/images/logos/acalourada.svg">
          <div class="textoMateria">
            <h3>Acalourada</h3>
            <p>
              A Acalourada Virtual é uma atividade de recepção dos estudantes ingressantes no curso de Ciência da Computação de forma totalmente virtual. Essa atividade já vem sendo desenvolvida de forma presencial há mais de 3 anos em conjunto com a Coordenação de Computação, o Departamento de Informática e o PET de Computação, e procura guiar os calouros através da universidade e do curso, além de mostrar as oportunidades que a universidade oferece tanto de forma pessoal como profissional.</p>
            <button class="botao"><a href="https://petcompufma.org/acalourada/index.php" target="_blank" style="text-decoration:none">Saiba mais</a></button>
          </div>
      </div>
    
      <div class="materia">
        <img src="./assets/images/logos/eacomp.svg">
          <div class="textoMateria">
            <h3>EAComp</h3>
            <p>
                O Encontro Acadêmico de Computação (EAComp) da UFMA é uma forma de receber novos alunos e familiarizá-los com o curso de Graduação de Ciência da Computação da UFMA apresentando as oportunidades dentro da graduação. O EAComp é organizado pelo Programa de Educação Tutorial do curso de Ciência da Computação (PETComp).
            </p>
            <button class="botao"><a href="https://petcompufma.org/eacomp/" target="_blank" style="text-decoration:none">Saiba mais</a></button>
          </div>
      </div>
